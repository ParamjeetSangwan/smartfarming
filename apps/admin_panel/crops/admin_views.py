# admin_panel/crops/admin_views.py
# FIX: crop_add_view, crop_edit_view, crop_delete_view were defined INSIDE
# the return statement of crop_list_view — completely unreachable.
# Moved them to module level where they belong.
